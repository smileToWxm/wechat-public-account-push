...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxc34ee8ed05048631',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'ca6e0715b2c3829d51e84f9be71f8cd5',
...
//   CALLBACK_TEMPLATE_ID: 'GT9wv2F0Cfyf1Q_D7ToP3Obdjegams78gwoUsoRgaI4',
...
//   ],
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    { keyword: 'encourage_oneself', contents: '我送你一束花，是想看到你收到花的高兴，而不是收到一束花的回礼！！' },
    // 这样配置的话，就会每次随机选一句话发送
    {
